# studiosoop_seoul | 프리미엄 스튜디오 웹사이트

studiosoop_seoul은 프리미엄 뷰티 서비스를 제공하는 전문 스튜디오의 공식 웹사이트입니다. Next.js 15, Tailwind CSS, shadcn/ui를 사용하여 제작된 모던한 웹사이트입니다.

## 🌟 프로젝트 소개

studiosoop_seoul은 개인의 특성에 맞춘 맞춤형 뷰티 서비스를 제공하는 전문 스튜디오입니다. 자연스럽고 정교한 서비스로 고객 개개인의 아름다운 스타일을 완성해드립니다.

## ✨ 주요 기능

* 🎨 **모던한 디자인**: 부드러운 그라데이션과 감성적인 UI/UX
...
* 💅 **브랜드 아이덴티티**: studiosoop_seoul만의 고유한 색상과 디자인 시스템
...
```bash
git clone https://github.com/freethedobby/studiosoop_seoul.git
cd studiosoop_seoul
```
...
3. **역할별 리디렉션**:
   * `admin@studiosoop.com` → `/admin` (관리자 대시보드)
...
_자연스럽고 정교한 뷰티 서비스로 당신만의 아름다운 스타일을 완성하세요._ ✨
