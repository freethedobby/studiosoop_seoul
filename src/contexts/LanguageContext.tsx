...
const translations = {
  en: {
    ...
    "dashboard.kycSoonMessage": "Customer registration application will start soon.",
    "dashboard.kycWaitingButton": "Waiting for customer registration application",
    "dashboard.kycClosedMessage": "Customer registration application period has ended.",
    "dashboard.kycClosedButton": "Customer registration application closed",
    ...
    "dashboard.reservationNoticeDesc": "Please read the required notices before making a reservation.",
    ...
    "dashboard.reservationAutoCancelled": "님의 예약이 입금 시간 만료로 자동 취소되었습니다.",
    ...
    "kyc.applicationCompletedDesc": "Customer registration application has been completed. We will notify you of the results after admin review.",
    "kyc.viewApplicationContent": "View Application Content",
    "kyc.applicationContentTitle": "Application Content Review",
    "kyc.applicationContentDesc": "You can review the customer registration application content you submitted.",
    "kyc.gender": "Gender",
    ...
    "kyc.applicationOpenSoonDesc": "Customer registration application will start soon. Time remaining until opening:",
    "kyc.applicationClosedDesc": "Customer registration application period has ended.",
    ...
    "login.privacyNotice": "By logging in, you agree to the privacy policy and terms of service",
    "reservation.title": "Make Reservation",
    "reservation.alreadyActiveReservation": "You already have an active reservation. Please cancel your existing reservation before making a new one.",
    "reservation.cancelConfirm": "Are you sure you want to cancel your reservation?",
    "reservation.cancelSuccess": "Reservation cancelled successfully",
    "reservation.cancelFailed": "Failed to cancel reservation. Please try again.",
    "reservation.autoCancelled": "님의 예약이 입금 시간 만료로 자동 취소되었습니다.",
    ...
    "reservation.paymentNameMatch": "신청자명과 입금자명이 같아야 입금처리 확정됩니다",
  ...
  ko: {
    ...
    "dashboard.reservationNoticeDesc": "예약하기 전에 반드시 필독사항을 확인해주세요.",
