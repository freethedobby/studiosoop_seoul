...
const translations = {
  en: {
    ...
    "kyc.applicationSuccess": "Application Completed!",
    "kyc.applicationSuccessDesc":
      "Your KYC application has been completed. We will notify you of the results after admin review.",
    "kyc.submitError": "An error occurred during submission:",
    "kyc.unknownError": "Unknown error",
    "kyc.loginRequired": "Login required",
    "kyc.submitStart": "KYC submission started",
    "kyc.firebaseConnection": "Firebase connection status",
    "kyc.submitComplete": "KYC application completed",
    "kyc.submitCompleteMessage":
      "Your KYC application has been completed. We will notify you of the results after review.",
...
By proceeding with treatment, you acknowledge that you have read, understood, and agree to all terms and conditions outlined in this document.`,
    ...
    "dashboard.unverifiedCustomer": "Unverified Customer",
  ...
  ko: {
    ...
    "kyc.apply": "신청하기",
    "kyc.submitting": "제출 중...",
    "kyc.applicationSuccess": "신청이 완료되었습니다!",
    "kyc.applicationSuccessDesc":
      "고객등록 신청이 완료되었습니다. 관리자 검토 후 결과를 알려드리겠습니다.",
    "kyc.submitError": "제출 중 오류가 발생했습니다:",
    "kyc.unknownError": "알 수 없는 오류",
    "kyc.loginRequired": "로그인이 필요합니다",
    "kyc.submitStart": "KYC 제출 시작",
    "kyc.firebaseConnection": "Firebase 연결 상태",
    "kyc.submitComplete": "KYC 신청 완료",
    "kyc.submitCompleteMessage":
...
시술을 진행함으로써 이 문서에 명시된 모든 약관을 읽고, 이해하며, 동의했음을 인정합니다.`,
    ...
    "common.minutes": "분",
    "common.seconds": "초",
    "dashboard.unverifiedCustomer": "미인증 고객",
    "dashboard.verify": "인증하기",
    "dashboard.memberStatus.none": "비회원",
